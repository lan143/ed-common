...
bool EDCommon::Relay::Relay::init(std::initializer_list<EDCommon::Relay::RelayOption> options)
{
...
std::pair<bool, bool> EDCommon::Relay::Relay::isEnabled()
{
    return isEnabledInternal();
}

bool EDCommon::Relay::Relay::setState(bool enable)
{
    if (xQueueSend(_commandQueue, &enable, 0) != pdTRUE) {
        return false;
    }
...
void EDCommon::Relay::Relay::update()
{
    bool cmd;
...
bool EDCommon::Relay::Relay::publishState()
{
